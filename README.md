...
This repository contains the GitOps deployment manifests for **ls1-jan212026**. These Kubernetes manifests define all the resources needed to deploy the application to your OpenShift/Kubernetes cluster via ArgoCD.
...
| 📂 **components/ls1-jan212026/** | Kustomize base and overlays for all Kubernetes resources |
...
|----------|------|-------------|
| 🖥️ **Deployment** | `ls1-jan212026` | Streamlit UI application |
| 🦙 **Deployment** | `ls1-jan212026-llama-stack` | Llama Stack inference server |
| 🦙 **Deployment** | `ls1-jan212026-ollama` | Ollama for safety/guardrails |
| ☸️ **Deployment** | `ls1-jan212026-mcp-server` | Kubernetes MCP Server |
| 🌐 **Services** | Various | Internal service networking |
| 🔀 **Route** | `ls1-jan212026` | External access to Streamlit UI |
| 🔐 **RBAC** | `ls1-jan212026-mcp-*` | Permissions for cluster introspection |
| 💾 **PVC** | `ls1-jan212026-ollama-data` | Persistent storage for Ollama models |
...
| Resource | Link |
|----------|------|
| 📝 **Source Repository** | [https://github.com/redhat-appstudio-mjf/ls1-jan212026](https://github.com/redhat-appstudio-mjf/ls1-jan212026) |
